...
def test():
    ...
    tests["Part A Tests (requires insert to work):"] = [
        ...
        #
        {
            "label": "Basic Insert 1.2b (Size: 2 | Height: "
            + str(get_height_of_tree(init_tree(4)))
            + ")",
            "input": init_tree(4),
        ...
        {
            "label": "Basic Insert 1.2c (Size: 3 | Height: "
            + str(get_height_of_tree(init_tree(4).insert(1)))
            + ")",
        ...
        {
            "label": "Basic Insert 1.2d (Size: 9 | Height: "
            + str(
                get_height_of_tree(
                    init_tree(4)
                    .insert(1)
        ...
        {
            "label": "Basic Insert 1.2e (Size: 15 | Height: "
            + str(
                get_height_of_tree(
                    init_tree(4)
                    .insert(1)
        ...
        {
            "label": "Basic Insert 1.2f (Size: 2 | Height: "
            + str(get_height_of_tree(init_tree(4)))
            + ")",
            "input": init_tree(4),
        ...
        {
            "label": "Basic Insert 1.2g (Size: 2 | Height: "
            + str(get_height_of_tree(init_tree(4).insert(1)))
            + ")",
            "input": init_tree(4),
        ...
        {
            "label": "Basic Insert 1.2h (Size: 3 | Height: "
            + str(get_height_of_tree(init_tree(4).insert(1)))
            + ")",
        ...
        {
            "label": "Basic Insert 1.2i (Size: 3 | Height: "
            + str(get_height_of_tree(init_tree(4).insert(1)))
            + ")",
            "input": init_tree(4).insert(5),
    ...
    tests["Part B Tests:"] = [
        ...
        },
        {
            ...
            "input": init_tree(10).insert(11).insert(12),
            "test": lambda T: multi_getattr(
                T.rotate("L", "R"), "right.right", "dontpersist"
            ),
            "expected": None,
            "show_expectation": False,
        },
        ...
        },
        {
            ...
            .insert(75),
            "test": lambda T: multi_getattr(
                T.rotate("L", "R"), "right.left.right.key", None
            ),
            "expected": 65,
            "show_expectation": False,
        },
        {
            ...
            .insert(75),
            "test": lambda T: multi_getattr(
                T.rotate("R", "L"), "left.right.left.key", None
            ),
            "expected": 35,
            "show_expectation": False,
        },
    ...
    for label, test_results in tests.items():
        ...
        for i, result in enumerate(test_results):
            ...
            # If failed, print failed and pring the expected and received values
            ...
            if not con and (
                ...
                print(
                    " - Expected " + str(result["expected"]) + " But Got " + str(res),
                    end="",
                )
            print()
            print(
                "\t Is Search Tree Property is Maintained? "
            ...
            if "count_calculate_sizes" in result and result["count_calculate_sizes"]:
                ...
                print(
                    "\t Number of sets/changes to to tree node sizes: "
